...
#============================exa.EGAD.sh================================#
#===Extract transcript GO-term annotation entries from the SEatlas2_2_trinotate.xls annotation report===#
#Extract transcripts and their associated GO-terms
#USE: source exa.EGAD.sh {searchterm}
